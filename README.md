...
## `> systemctl status hoang`

```yaml
building: AI developer tooling @ OpenNezt
learning: Kubernetes · CI/CD · Terraform · Cloud (AWS/GCP)
goal_2026: DevOps / Platform Engineering
```
...
<!-- TODO: thay [Repo](#) bằng link GitHub thật của VAIC / SmartAdmin / Rentra khi public -->
...
[![OpenNezt Live](https://img.shields.io/badge/opennezt.com-Live_Demo-6AE2F7?style=for-the-badge&logo=googlechrome&logoColor=0d1117)](https://opennezt.com)
...
> _"Không cần giỏi nhất ngay từ đầu — cần đủ tò mò để tiếp tục build."_
